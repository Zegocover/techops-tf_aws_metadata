...
- [protobuf-authoring.md](protobuf-authoring.md) — protobuf authoring conventions: no cross-service message imports, contract-level comments, field optionality and numbering, the success/failure result model, and the local `buf` validation workflow.
