...
`.claude/skills/zego-write-skill/persuasion-principles.md` as needing Authority + Commitment), three scenarios
is insufficient — see `.claude/skills/zego-write-skill/testing-skills-with-subagents.md` for the full
...
See `.claude/skills/zego-write-skill/testing-skills-with-subagents.md` for the full TDD
