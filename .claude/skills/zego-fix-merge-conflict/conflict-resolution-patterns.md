...
`zego-fix-merge-conflict` skill. Read this when building and executing a resolution
...
- **Tier 3 — needs-design:** resolving would require authoring significant new
  ...
  (`git rebase --abort` + route to `zego-write-design-doc`). A merge-conflict resolver
