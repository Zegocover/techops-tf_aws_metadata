...
You are executing the `zego-ci-validation` skill. Discover the repo's CI
...
`.py`, `.ts`, `.tsx`, `.js`, `.jsx`, `.java`, `.kt`, `.swift`, `.scala`, `.go`,
`.rb`, `.rs` — i.e. only documentation, configuration, or data files.
